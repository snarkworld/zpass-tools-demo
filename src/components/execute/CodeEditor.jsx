...
const aleoSyntaxHighlight = {
  start: [
    {
      regex:
        /(?:^|\s)(function|program|as|by|interface|closure|into|import)(?:$|\s)/,
      token: 'keyword',
    },
    {
  ...
  return (
    <section
      style={{
        ...
        height: '300px',
        outline: isFocused ? `1px solid ${token.colorPrimaryHover}` : 'none',
        boxShadow: isFocused
          ? `0 0 0 ${token.controlOutlineWidth + 1}px ${token.controlOutline}`
          : 'none',
      }}
    >
      <CodeMirror
        ...
        value={value}
        extensions={[StreamLanguage.define(simpleMode(aleoSyntaxHighlight))]}
